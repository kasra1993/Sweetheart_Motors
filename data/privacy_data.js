export const privacyDesc = (
  <span>
    This privacy notice discloses the privacy practices for RTEEN AUTO. This
    ...
    inaccuracies in the information. Information Collection, Use, and Sharing We
    ...
    <br />
    <br />
    Your Access to and Control Over Information You may opt out of any future
    ...
    about you. Have us delete any data we have about you. Express any concern
    you have about our use of your data. Security We take precautions to protect
    your information. When you submit sensitive information via the website,
    ...
    contact us immediately via telephone at 6047824240
  </span>
);
